...
By accessing and using the GoGaijin mobile application ("App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use the App.

## Description of Service

GoGaijin is a mobile application that helps foreigners in Tokyo find English-speaking services including healthcare, dining, housing, and essential services. The App includes an AI assistant feature and location-based recommendations.
...
### You May
- Use the App to find and contact service providers
- Submit honest reviews and ratings
...
- Reviews should be helpful and relevant to other users
...
- Service providers listed in the App are independent third parties
- We do not endorse or guarantee the quality of third-party services
- Your interactions with service providers are solely between you and them
...
- Service information may change without notice
- Users should verify information directly with service providers

## Location Services

- The App uses location services to provide relevant recommendations
- Location data is used in accordance with our Privacy Policy
- You can disable location services but this may limit App functionality

## AI Assistant

- The AI assistant provides general information and recommendations
...
- We own or license all trademarks, logos, and brand names in the App
- You may not use our intellectual property without permission

### Your Rights
- You retain rights to content you create and submit
...
### Information Accuracy
- Information in the App is provided "as is" without warranties
...
We may update these Terms periodically. We will notify users of material changes through the App or email. Continued use of the App after changes constitutes acceptance of the new Terms.
...
These Terms, together with our Privacy Policy, constitute the entire agreement between you and GoGaijin regarding the use of the App.
